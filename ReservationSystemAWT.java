...
public class ReservationSystemAWT extends Frame {
    ...
    public ReservationSystemAWT() {
        ...
        setBackground(Color.decode("#f59cb5"));

        outputTextArea = new TextArea();
        outputTextArea.setEditable(false);
        outputTextArea.setBackground(Color.white);
        outputTextArea.setForeground(Color.decode("#5c3561"));
        add(outputTextArea, BorderLayout.CENTER);

        Panel panel = new Panel();
        panel.setLayout(new FlowLayout());
        panel.setBackground(Color.decode("#5c3561"));
        ...
        makeReservationButton.setBackground(Color.decode("#f59cb5"));
        viewReservationsButton.setBackground(Color.decode("#f59cb5"));
        cancelReservationButton.setBackground(Color.decode("#f59cb5"));
        exitButton.setBackground(Color.decode("#f59cb5"));

        makeReservationButton.setForeground(Color.decode("#5c3561"));
        viewReservationsButton.setForeground(Color.decode("#5c3561"));
        cancelReservationButton.setForeground(Color.decode("#5c3561"));
        exitButton.setForeground(Color.decode("#5c3561"));
    ...
    private void showMakeReservationDialog() {
        ...
        frame.setBackground(Color.decode("#5c3561"));

        Label nameLabel = new Label("Customer Name:");
        nameLabel.setForeground(Color.decode("#f59cb5"));
        TextField nameTextField = new TextField();

        Label dateLabel = new Label("Reservation Date:");
        dateLabel.setForeground(Color.decode("#f59cb5"));
        TextField dateTextField = new TextField();

        Label guestsLabel = new Label("Number of Guests:");
        guestsLabel.setForeground(Color.decode("#f59cb5"));
        TextField guestsTextField = new TextField();

        Button submitButton = new Button("Submit");
        submitButton.setBackground(Color.decode("#f59cb5"));
        submitButton.setForeground(Color.decode("#5c3561"));
    ...
    private void showCancelReservationDialog() {
        ...
        idLabel.setForeground(Color.decode("#f59cb5"));
